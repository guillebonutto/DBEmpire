...
async function testUpdate() {
    ...
    items.forEach(it => {
        let qty = it.quantity;
        // If it is the adaptor, set quantity to 3
    ...
    try {
        ...
        for (const p of selectedProductsGrouped) {
            if (!p.isNew && p.product.id) {
                ...
                console.log(`Ejecutando lógica de actualización en JS para ${p.product.name}...`);
        ...
        console.log("Esperando promesas de productos...");
