...
async function run() {
    const { data: items } = await supabase.from('supplier_order_items').select('*').eq('supplier_order_id', '6762e646-1277-4ddd-9cd2-093ee24552ee');
    console.log("Items for order 6762e646 (Nico):", items);
}
run();
